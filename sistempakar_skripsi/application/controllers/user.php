...
class User extends CI_Controller
{
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Profil anda sudah di update</div>');
            redirect('user');
        }
    }
        ...
        if ($this->form_validation->run() == false) {
            ...
            if (!password_verify($current_password, $data['user']['password'])) {
                ...
                if ($current_password == $new_password) {
                    ...
                    $this->db->update('user');
                    $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Password Sudah berhasil diganti</div>');
                    redirect('user/changepassword');
                }
            }
        }
