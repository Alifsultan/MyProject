                        ...
                        <form method="POST" action="f_create_task.php">
                            <div class="form-group">
                                ...
                                <input type="text" name="divisi" class="form-control" required
                                    value="<?php echo $_SESSION['divisi'] ?>" readonly />
                                <br />
                                <label>Task</label>
                                ...
                                <input type="text" name="detail_task" class="form-control"
                                    placeholder="Enter Detail Task" style="border: 1px solid #000000" required>
                                <br />
